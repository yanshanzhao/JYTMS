...
{
    public partial class FrmSRCXCP : Form
    {
        #region 成员变量
        private ClsG ObjG;
        ...
        public void Prepare(int level,DateTime kssj, DateTime jssj, string jgid, string ywqy, string jgmc)
        {
            ObjG = Session["ObjG"] as ClsG; 
            ClsPopulateCmbDsS.PopuYd_cplx_qb(CmbYwqy, ClsGlobals.CntStrKj);
            CmbYwqy.SelectedValue = ywqy;
            DtpStart.Value = kssj;
            DtpStop.Value = jssj.AddDays(-1);
            PriJgid = jgid;
            PriLevel = level;
            this.TxtSljg.Text = jgmc;
