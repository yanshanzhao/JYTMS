...
{
    public partial class FrmDSKCKLSelect_FKFS : UserControl
    {
        #region 成员变量
        private ClsG ObjG;
        ...
        private FrmDskCklMx_FKFS f;
        private DataTable PriDt;
        #endregion

        public FrmDSKCKLSelect_FKFS()
        {
            InitializeComponent();
        }
        #region 初始化数据
        ...
        private void BtnExl_Click(object sender, EventArgs e)
        {
            ...
            ClsExcel.CreatExcel(Dgv, "代收款存款率(付款方式)", ctrlDownLoad2,new int[]{1,2,3});
        }
